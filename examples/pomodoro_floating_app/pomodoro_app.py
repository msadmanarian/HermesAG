"""
Floating Pomodoro Timer Application with Obsidian Vault Integration.
Demonstrated in Tina Huang's Hermes Agent video.
Features:
- Always-on-top compact window
- Work/break timer with audio cues
- Automatically logs completed sessions to Obsidian Second Brain
"""
...
class FloatingPomodoroApp:
    def __init__(self, root, vault_path="data/obsidian_vault"):
        ...
        self.root.geometry("240x120+120+120")
        ...
        self.start_btn = tk.Button(self.btn_frame, text="Start", command=self.toggle_timer, bg="#89b4fa", fg="#11111b", font=("Helvetica", 10, "bold"))
        self.start_btn.pack(side=tk.LEFT, padx=4)

        self.reset_btn = tk.Button(self.btn_frame, text="Reset", command=self.reset_timer, bg="#f38ba8", fg="#11111b", font=("Helvetica", 10, "bold"))
